"""IT Job Board Scraper"""
from typing import List, Dict
from ..utils.base_scraper import BaseScraper

class ITJobBoardScraper(BaseScraper):
    @property
    ...
    def base_url(self) -> str:
        return "https://www.itjobboard.com"
            ...
            for card in job_cards:
                try:
                    ...
                    job_data = {
                        ...
                        'posted_date': None,
                        'location': self.clean_text(card.find('div', class_='location').get_text() if card.find('div', class_='location') else ''),
                        'job_description': '',
