"""Escape The City Scraper"""
from typing import List, Dict
from ..utils.base_scraper import BaseScraper

class EscapeTheCityScraper(BaseScraper):
    @property
    def portal_name(self) -> str:
        return "Escape The City"
    
    @property
    def base_url(self) -> str:
        return "https://www.escapethecity.org"
    ...
    def scrape_jobs(self) -> List[Dict]:
        ...
        for keyword in self.keywords:
            ...
            job_cards = soup.find_all('div', class_='opportunity')
