...
class RemoteCoScraper(BaseScraper):
    ...
    def build_search_url(self, keyword: str) -> str:
        return f"{self.base_url}/remote-jobs/search/?search_keywords={keyword}"
    ...
    def scrape_jobs(self) -> List[Dict]:
        ...
        for keyword in self.keywords:
            ...
            job_cards = soup.find_all('div', class_='job_listing') or \
            ...
            for card in job_cards:
                try:
                    ...
                    # Extract from card
                    company = ''
                    company_elem = card.find('p', class_='company') or \
                    ...
                    try:
                        ...
                        logger.debug(f"Remote.co: Error fetching job detail for {job_link}: {e}")
                    ...
                    logger.debug(f"Remote.co: Error parsing job card: {e}")
                    continue
        return jobs
    ...
    def _fetch_job_detail(self, job_link: str) -> Dict[str, Optional[str]]:
        ...
        try:
            ...
            logger.debug(f"Remote.co: Error fetching job detail: {e}")
