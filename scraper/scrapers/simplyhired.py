...
class SimplyHiredScraper(BaseScraper):
    ...
    def scrape_jobs(self) -> List[Dict]:
        ...
        for keyword in self.keywords:
            ...
            job_cards = soup.find_all('div', class_='SerpJob-jobCard') or \
            ...
            for card in job_cards:
                try:
                    ...
                    # Extract from card
                    company = ''
                    company_elem = card.find('span', class_='JobPosting-labelWithIcon') or \
                    ...
                    location = ''
                    location_elem = card.find('span', class_='jobposting-location') or \
                    ...
                    posted_date = None
                    date_elem = card.find('span', class_='JobPosting-labelWithIcon jobposting-age') or \
                               card.find('time') or \
                    ...
                    try:
                        ...
                        logger.debug(f"SimplyHired: Error fetching job detail for {job_link}: {e}")
                    ...
                    logger.debug(f"SimplyHired: Error parsing job card: {e}")
                    continue
        return jobs
    ...
    def _fetch_job_detail(self, job_link: str) -> Dict[str, Optional[str]]:
        ...
        try:
            ...
            logger.debug(f"SimplyHired: Error fetching job detail: {e}")
